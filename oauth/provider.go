...
// # Stability
//
// Stability class: frozen-v1 candidate for the core flow. The exported API of this package is
// intended to remain backward-compatible for the life of v1; breaking changes require a new
// major version. The ready-made constructors in oauth/providers are experimental. Until v1 is
// tagged the API remains pre-1.0. See docs/adr/0001-v1-scope-and-stability-classes.md.
package oauth
