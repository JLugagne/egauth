...
// nor be trivially guessable (all-zero or a repeated single byte); the key id may be empty (the
// legacy kid-less mode). The weak-key bypass lives at the Config level, not here.
